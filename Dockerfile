...
ARG FROM=debian:13.5@sha256:d07d1b51c39f51188e60be9b64e6bf769fa94e187f092bc32b91305cfa34ba5a
...
RUN apt-get update && \
    apt-get install --no-install-recommends -y \
        ...
        python3 \
        quilt
ARG OVS_COMMIT=73e38c8dfd9ff5f95a92e583780cd996ac11bca7
